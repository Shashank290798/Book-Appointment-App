...
btn.addEventListener('click',(e)=>{
    ...
    const obj={
           ...
           console.log(obj);
             axios.post("http://localhost:3000/bookopen/details",obj)
             .then((response)=>{
...
function showListofRegisteredUser(user){
     ...
     window.addEventListener('DOMContentLoaded', (e) => {
        ...
        e.preventDefault();
            axios.get("http://localhost:3000/bookopen/userinfo")
            .then((response)=>{
                console.log(response)
    ...
    function deleteUser(userid)
    {
        ...
        axios.delete(`http://localhost:3000/bookopen/del/${userid}`)
